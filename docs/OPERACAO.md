...
- **Expurgo (LGPD Art. 15/16)**: `pnpm purge:data` apaga trilha de auditoria e extrações vencidas e também links/códigos de 2 etapas expirados. Da trilha apaga só o **começo da cadeia de selos** (um registro velho que ficou depois de um ainda dentro do prazo espera o expurgo seguinte); a verificação de integridade recomeça do primeiro que sobrou e isso não é tratado como adulteração.
...
- **"A trilha foi adulterada" com "este registro está sem selo"**: o servidor só sela o registro que ele mesmo acabou de gravar; se a selagem falhou e o processo reiniciou (veja o log `audit.seal.failed`), ou se são registros anteriores à selagem, ficam sem selo. Se você tem certeza de que ninguém mexeu no banco, um **administrador** usa o botão "selar os pendentes" na própria mensagem; a decisão fica na trilha. Se não tem certeza, trate como abaixo.
...
- **A última empresa foi eliminada (LGPD) ou a instalação é nova**: entre como coordenador ou administrador e o app mostra "Cadastrar a empresa" (CNPJ, razão social, setor). Os exercícios se abrem na Tabulação. O analista vê um aviso para pedir a quem pode cadastrar. (Com outras empresas cadastradas, a eliminação só leva a empresa em análise e o app passa para a primeira que sobrou; novas empresas entram pelo seletor da barra lateral.)
