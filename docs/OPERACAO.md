...
- **A empresa foi eliminada (LGPD) ou a instalação é nova**: entre como administrador e o app mostra "Cadastrar a empresa" (CNPJ, razão social, setor). Os exercícios se abrem na Tabulação. Os demais perfis veem um aviso para pedir ao administrador.
