...
- **Perdeu o acesso de administrador** (senha esquecida sem SMTP, conta desativada): o sistema impede rebaixar/desativar o último, mas se acontecer, defina `SEED_ADMIN_EMAIL` e `SEED_ADMIN_PASSWORD` e rode `pnpm admin:ensure` — recria ou restabelece o administrador (ativo, com a nova senha, derrubando as sessões dele) sem apagar nenhum dado.
