...
export type Permission =
  ...
  | "cadastrar-empresa" // cadastrar uma empresa-cliente para análise
  ...
  | "registrar-parecer" // registrar a decisão de crédito (alçada de aprovação)
