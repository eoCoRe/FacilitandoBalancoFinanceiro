...
import { mailAvailable, resetMailTransport, sendMail, smtpConfigured } from "@/lib/server/mail/mail"
import { activationCodeMail, loginCodeMail, resetPasswordMail } from "@/lib/server/mail/mail-templates"
